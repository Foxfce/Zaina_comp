import { assets, testimonialsData } from '../assets/mockup/assets'
...
function Testimonial({ }: Props) {
    return (
        <motion.div
            ...
            <p className='text-center text-gray-500 mb-8 max-w-80 mx-auto'>Stories from Those Who Found Home with Us</p>

            <div className='flex flex-wrap justify-center gap-8'>
                {testimonialsData.map((testimonial, index) => (
                    <div
                        className='max-w-[340px] border-softperl-accent-dark shadow-lg rounded px-8 py-12 text-center bg-softperl-primary'
                        key={index}>
                        <img
