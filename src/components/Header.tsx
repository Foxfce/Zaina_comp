    ...
    <div className="min-h-screen mb-4 bg-cover bg-center flex item-center w-full overflow-hidden" style={{ backgroundImage: "url('/header_img.png')" }} id='Header'>
      ...
      >
        ...
        <div className="space-x-6 mt-16">
          <a href="#Projects" className="transition-all"><button className="btn-transparent transition-all">Products</button></a>
          <a href="#Contact" className="transition-all"><button className="btn-main-2 transition-all">Contact Us</button></a>
        </div>
